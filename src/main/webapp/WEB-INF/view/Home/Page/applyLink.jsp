                ...
                <div class="single-content">
                    <form class="layui-form layui-form-pane" id="applyLinkForm" method="post">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="linkUrl" placeholder="如: <%=basePathCopy%>"
                                       class="layui-input" required>
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="linkDescription" placeholder="如: ${options.optionSiteDescription}"
                                       class="layui-input" required>
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item layui-form-text">
                            ...
                            <div class="layui-input-block">
                                <textarea name="linkOwnerContact" placeholder="申请原因和联系方式" class="layui-textarea" maxlength="100"></textarea>
                            </div>
                        </div>
